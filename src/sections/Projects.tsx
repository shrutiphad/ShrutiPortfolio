      ...
      <div className="container">
        ...
        <div className="flex flex-col md:mt-20  mt-10 gap-20"> 
          ...
          {portfolioProjects.map(project => (
            ...
            after:absolute after:inset-0 after:bg-violet-500 after:outline after:outline-offset-2 after:outline-2 after:rounded-3xl after:outline-white/20 md:pt-12 lg:pt-16 lg:px-20 md:px-10
